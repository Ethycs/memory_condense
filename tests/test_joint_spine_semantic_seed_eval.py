...
def setup_runtime(tmp_path, monkeypatch, *, changed_live=False):
    ...
    contexts = {"source_spine_diverse": "EXACT_RAW_CONTROL",
        "source_spine_semantic_seeds": "EXACT_RAW_SEMANTIC_SELECTION"}
    calls = []
    ...
    class Memory:
        ...
        def retrieve(self, query, route, dated_question):
            ...
            context = "CHANGED_EVIDENCE" if changed_live and route == "source_spine_semantic_seeds" else contexts[route]
