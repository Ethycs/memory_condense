...
from tools.compile_bounded_native_spine_hierarchy import FORMAT, implementation
...
from tools.prepare_bounded_native_spine_attention import validate_admission


class BoundedParentNativeSpineCorpus(ParentBudgetNativeSpineCorpus):
