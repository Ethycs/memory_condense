...
from tools import compile_reused_native_spine_exchanges as reused_exchanges
from tools import prepare_reused_native_spine_attention as attention_admission
...
FORMAT = "native-spine-expanded-parent-producer-v1"


def implementation():
    return {**parent.implementation(), **attention_admission.implementation(),
            "tools/compile_expanded_native_spine_hierarchy.py": digest(__file__)}
