...
from tools import compile_expanding_native_spine_exchanges as reused_exchanges
from tools import compile_recovered_native_spine_hierarchy as previous
from tools import prepare_expanding_native_spine_attention as attention_admission
...
FORMAT = "native-spine-expanding-parent-producer-v1"


def implementation():
    return {**previous.implementation(), **attention_admission.implementation(),
            "tools/compile_expanding_native_spine_hierarchy.py": digest(__file__)}
