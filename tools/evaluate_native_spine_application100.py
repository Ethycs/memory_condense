"""Evaluate sealed retrieval policies on 100 questions from persisted memory.

Reuse one application ingestion, the unchanged v7 reader and original grading.
Policies may change numeric retrieval limits; no question-specific inputs enter
routing. This exposed development set does not establish generalization.
"""
import argparse
...
PACKET_BASELINE = Path('eval_results/native-spine-app-reader100-v7-20260915-r1')
...
def validate_plan(plan):
    ...
    if (comparison.payload['reader_policy'] != p['reader_policy']
