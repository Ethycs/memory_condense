"""Compare source-spine overflow with additional user-summary passage addresses.
...
ARMS = ("short_api", "source_spine_overflow", "source_spine_overflow_api", "source_spine_facets", "source_spine_facets_api")
IMPLEMENTATION = ("tools/evaluate_source_spine_facets.py", "tools/evaluate_source_spine_overflow.py", "tools/spine_facet_memory.py",
...
def prepare(root, index_root, addresses_root, atoms_path, facets_root):
    ...
    artifact, _ = publish_sealed_json(root / "preflight.json", {
        "format": "memory-condense-joint-source-spine-facets-eval-v1", "index_root": str(index_root.resolve()),
