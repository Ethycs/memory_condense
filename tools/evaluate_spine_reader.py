"""Compare reader policies on identical live source-spine evidence packets.
...
IMPLEMENTATION = ("tools/evaluate_spine_reader.py", "tools/evaluate_source_spine.py",
...
def prepare(root, index_root, addresses_root, atoms_path):
    ...
    artifact, _ = publish_sealed_json(root / "preflight.json", {
        "format": "memory-condense-joint-spine-reader-eval-v1", "index_root": str(index_root.resolve()),
