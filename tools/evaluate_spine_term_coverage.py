"""Compare passage routing with source-scoped summary-term coverage.
...
from tools.spine_term_memory import ResidentMemory
...
MEMORY_ARMS = ("source_spine_facets", "source_spine_term_coverage")
ARMS = ("short_api", "source_spine_facets", "source_spine_facets_api", "source_spine_term_coverage", "source_spine_term_coverage_api")
...
IMPLEMENTATION = ("tools/evaluate_spine_term_coverage.py", "tools/spine_term_memory.py",
...
def prepare(root, index_root, addresses_root, atoms_path, facets_root):
    ...
    artifact, _ = publish_sealed_json(root / "preflight.json", {
        "format": "memory-condense-joint-spine-term-coverage-eval-v1", "index_root": str(index_root.resolve()),
        ...
        "term_coverage": TERM_COVERAGE_POLICY,
