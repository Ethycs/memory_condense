...
from tools.compile_expanded_native_spine_hierarchy import FORMAT, implementation
...
from tools.prepare_reused_native_spine_attention import validate_admission


class ExpandedParentNativeSpineCorpus(ParentBudgetNativeSpineCorpus):
