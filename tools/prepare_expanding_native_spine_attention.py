...
from tools import compile_expanding_native_spine_exchanges as exchanges
...
FORMAT = "native-spine-expanding-attention-admission-v1"


def implementation():
    return {**attention.implementation(), **exchanges.implementation(),
            "tools/prepare_expanding_native_spine_attention.py": digest(__file__)}
