...
from tools import compile_recovered_native_spine_exchanges as exchanges
...
FORMAT = "native-spine-recovered-attention-admission-v1"


def implementation():
    return {**attention.implementation(), **exchanges.implementation(),
            "tools/prepare_recovered_native_spine_attention.py": digest(__file__)}
