...
from tools import compile_reused_native_spine_exchanges as exchanges
...
FORMAT = "native-spine-reused-attention-admission-v1"


def implementation():
    return {**attention.implementation(), **exchanges.implementation(),
            "tools/prepare_reused_native_spine_attention.py": digest(__file__)}
