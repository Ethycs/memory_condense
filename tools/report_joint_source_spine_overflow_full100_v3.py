...
from tools.verify_spine_admission_method_v3 import load_verified_method as load_method
...
def report(roots, output_root):
    ...
    artifact, _ = publish_sealed_json(output_root / "joint-full100.json", {
        "format": "memory-condense-joint-source-spine-overflow-full100-v3", "probes_sha256": probes.sha256,
        ...
        "admission_comparison": "replayed conditional source admission v3 with complete deterministic compaction batches and transport attempt accounting",
