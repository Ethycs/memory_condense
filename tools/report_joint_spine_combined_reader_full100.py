...
from tools.verify_spine_admission_method_v8 import load_verified_method as load_method
...
def report(roots, output_root):
    ...
    artifact, _ = publish_sealed_json(output_root / "joint-full100.json", {
        "format": "memory-condense-joint-spine-combined-reader-full100-v1", "probes_sha256": probes.sha256,
        ...
        "admission_comparison": "replayed conditional source admission v8 with preserved summaries, bounded invalid-slot recovery, and complete terminal-run transport accounting",
