...
from tools.verify_spine_admission_method_v9 import load_verified_method as load_method
...
def report(roots, output_root):
    ...
    artifact, _ = publish_sealed_json(output_root / "joint-full100.json", {
        "format": "memory-condense-joint-spine-semantic-seeds-full100-v1", "probes_sha256": probes.sha256,
        ...
        "admission_comparison": "replayed conditional source admission v9 with preserved summaries, bounded invalid-slot recovery, and raw plus compaction-only transport accounting",
