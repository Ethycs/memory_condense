...
from tools import evaluate_spine_term_coverage as evaluation
from tools.compile_spine_semantic_index import load_index
from tools.verify_spine_admission_method_v7 import load_verified_method as load_method
...
def report(roots, output_root):
    ...
    artifact, _ = publish_sealed_json(output_root / "joint-full100.json", {
        "format": "memory-condense-joint-spine-term-coverage-full100-v1", "probes_sha256": probes.sha256,
        ...
        "admission_comparison": "replayed conditional source admission v7 with unchanged summaries, bounded compaction, and complete terminal-run transport accounting",
