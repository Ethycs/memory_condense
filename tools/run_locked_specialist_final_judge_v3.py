#!/usr/bin/env python3
"""Judge the replay-authenticated locked full-100 reconciliation V3 answers.

This is a thin identity adapter over the audited full-100 Sol judge lifecycle.
The shared engine authenticates the sealed V3 answer run and byte-identical
replay before it opens locked gold, then seals exactly 100 unique judge prompts.
...
from tools import run_locked_specialist_final_reconcile_v3 as answer_v3  # noqa: E402
...
PREFLIGHT_FORMAT = (
    "memory-condense-locked-specialist-final-reconciliation-sol-judge-"
    "preflight-v3"
)
JUDGE_FORMAT = (
    "memory-condense-locked-specialist-final-reconciliation-sol-judge-v3"
)
SCORE_FORMAT = (
    "memory-condense-locked-specialist-final-reconciliation-sol-score-v3"
)
...
SCORE_NAME = "locked-specialist-final-reconciliation-score-v3.json"
SCORE_REPLAY_NAME = (
    "locked-specialist-final-reconciliation-score-replay-v3.json"
)
CHECKPOINT_DIR_NAME = (
    "sol-locked-specialist-final-reconciliation-judge-calls-v3"
)
...
class LockedSpecialistFinalJudgeV3Error(MatchedEvalContractError):
    """Raised when the full-100 reconciliation V3 judge contract changes."""


def _require(ok: object, message: str) -> None:
    if not ok:
        raise LockedSpecialistFinalJudgeV3Error(message)
...
def build_runtime(
    ...
    *,
    ...
    _require(
        ...
        "full-100 reconciliation V3 judge runtime differs from sealed preflight",
    )
    return FastCompletionRuntime(
        ...
        benchmark_provenance={
            ...
            "arm": "locked_specialist_final_reconciliation_sol_judge_v3",
...
__all__ = [
    ...
    "JUDGE_NAME",
    "JUDGE_REPLAY_NAME",
    "LockedSpecialistFinalJudgeV3Error",
    "PREFLIGHT_FORMAT",
    "PREFLIGHT_NAME",
    "QUESTION_COUNT",
    "SCORE_FORMAT",
