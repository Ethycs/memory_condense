...
from tools import report_joint_spine_semantic_seeds_full100_v2 as reporting
...
IMPLEMENTATION = ("tools/run_spine_semantic_seed_full100_v2.py", "tools/run_spine_reader_after_timeout.py",
    "tools/execute_spine_transport_recovery.py", "tools/probe_spine_gateway_readiness.py")
PROTOCOL_IMPLEMENTATION = (*evaluation.IMPLEMENTATION, "tools/report_joint_spine_semantic_seeds_full100_v2.py",
    "tools/verify_spine_admission_method_v10.py", "tools/spine_compaction_transport.py",
...
def runner_payload(protocol, bindings):
    return {"format": "memory-condense-semantic-seed-full100-runner-v2", "protocol_sha256": protocol.sha256,
